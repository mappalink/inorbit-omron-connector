...
# This script builds the Docker image for the Omron Connector.
...
IMAGE_NAME="us-central1-docker.pkg.dev/inorbit-integrations/connectors/inorbit_omron_connector"
IMAGE_NAME_SHORT="inorbit_omron_connector"
