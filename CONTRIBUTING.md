...
Ready to contribute? Here's how to set up `inorbit-omron-connector` for local development.

1. Fork the `inorbit-omron-connector` repo on [GitHub](https://github.com/mappalink/inorbit-omron-connector).

2. Clone your fork locally:

   ```bash
   git clone git@github.com:{your_username_here}/inorbit-omron-connector.git
   ```

3. Install the project in editable mode using [`uv`](https://github.com/astral-sh/uv):

   ```bash
   cd inorbit-omron-connector
   uv sync --extra dev
   ```
...
7. Submit a pull request through the [GitHub](https://github.com/mappalink/inorbit-omron-connector/pulls) website.
